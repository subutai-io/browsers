...
;(function(window, document) {
  ...
  window.swalClasses2 = {
    modal: 'sweet-alert2',
    overlay: 'sweet-overlay2',
    confirm: 'sweet-confirm2',
  ...
  var getModal = function() {
    return document.querySelector('.' + window.swalClasses2.modal);
  };

  var getOverlay = function() {
    return document.querySelector('.' + window.swalClasses2.overlay);
  };
   ...
   */
  window.sweetAlert2 = window.swal2 = function() {
   ...
   */
  window.sweetAlert2.closeModal = window.swal2.closeModal = function() {
    closeModal();
  };
   ...
   */
  window.sweetAlert2.clickConfirm = window.swal2.clickConfirm = function() {
    var modal = getModal();
    var $confirmButton = modal.querySelector('button.' + window.swalClasses2.confirm);
    $confirmButton.click();
  };
   ...
   */
  window.sweetAlert2.clickCancel = window.swal2.clickCancel = function() {
    var modal = getModal();
    var $cancelButton = modal.querySelector('button.' + window.swalClasses2.cancel);
    $cancelButton.click();
  };
  ...
  function modalDependant() {
    ...
    switch (typeof arguments[0]) {
      ...
      case 'object':
         ...
         */
        window.sweetAlert2.callback = window.swal2.callback = function(isConfirm) {
    ...
    var onButtonEvent = function(event) {
      ...
      var targetedConfirm = hasClass(target, window.swalClasses2.confirm);
      var targetedCancel  = hasClass(target, window.swalClasses2.cancel);
  ...
  function setParameters(params) {
    ...
    var $content = modal.querySelector('div.sweet-content2');
    var $confirmBtn = modal.querySelector('button.' + window.swalClasses2.confirm);
    var $cancelBtn = modal.querySelector('button.' + window.swalClasses2.cancel);
    var $btnSpacer = modal.querySelector('hr.sweet-spacer2');
    ...
    // Custom Class
    modal.className = window.swalClasses2.modal;
    ...
    // Custom image
    var $customImage = modal.querySelector('.sweet-image2');
    if (params.imageUrl) {
    ...
    $confirmBtn.className = window.swalClasses2.confirm;
    addClass($confirmBtn, params.confirmButtonClass);
    $cancelBtn.className = window.swalClasses2.cancel;
  ...
  function openModal() {
    ...
    show(modal);
    addClass(modal, 'show-sweet-alert2');
    removeClass(modal, 'hide-sweet-alert2');
  ...
  function closeModal() {
    ...
    _hide(getOverlay());
    _hide(modal);
    removeClass(modal, 'showSweetAlert2');
    addClass(modal, 'hideSweetAlert2');
